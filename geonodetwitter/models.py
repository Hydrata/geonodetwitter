...
class TwitterRouter(object):
    ...
    def db_for_read(self, model, **hints):
        ...
        """
        if model._meta.app_label == 'geonodetwitter':
            return 'datastore'
        return None
    ...
    def allow_relation(self, obj1, obj2, **hints):
        ...
        """
        if obj1._meta.app_label == 'geonodetwitter' or \
           obj2._meta.app_label == 'geonodetwitter':
           return True
        return None
    ...
    def allow_syncdb(self, db, model):
        ...
        """
        if db == 'datastore':
            return model._meta.app_label == 'geonodetwitter'
        elif model._meta.app_label == 'geonodetwitter':
            return False
        return None